...
export const PageCarrello = () => {
  const { products, rimuoviProdotto, totaleImporto } =
    useContext(ContextCarrello)
  return (
    <div className="p-4 max-w-4xl mx-auto">
      ...
      <div className="text-right mt-8">
        ...
        <Link to="/checkout" className="inline-block mt-4 bg-green-600 text-white px-6 py-2 rounded hover:bg-green-700">
        Checkout
        </Link>
      </div>
    </div>
